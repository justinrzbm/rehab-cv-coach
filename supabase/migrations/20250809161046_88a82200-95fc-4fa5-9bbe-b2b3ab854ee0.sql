...
create policy "Users can view their exercise attempts" on public.exercise_attempts
for select using (auth.uid() = user_id);
create policy "Users can insert their exercise attempts" on public.exercise_attempts
...
create policy "Users can view their module attempts" on public.module_attempts
for select using (auth.uid() = user_id);
create policy "Users can insert their module attempts" on public.module_attempts
for insert with check (auth.uid() = user_id);
...
create policy "Users can view their module task attempts" on public.module_task_attempts
for select using (
  exists (
...
create policy "Users can insert their module task attempts" on public.module_task_attempts
...
create trigger trigger_calculate_exercise_improvements
