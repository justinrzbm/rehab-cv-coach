...
import subprocess
import time
from config import PROCESSING_WIDTH, PROCESSING_HEIGHT, YOLO_IMG_SIZE, DISPLAY_WIDTH, DISPLAY_HEIGHT
...
def print_header():
    ...
    print(f"Performance: {PROCESSING_WIDTH}x{PROCESSING_HEIGHT} @ YOLO {YOLO_IMG_SIZE}")
    print(f"Display: {DISPLAY_WIDTH}x{DISPLAY_HEIGHT} (upscaled)")
